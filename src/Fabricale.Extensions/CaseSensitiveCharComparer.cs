...
/// <summary>
/// Defines a Char Comparer that checks if two characters are the same (case sensitive)
/// </summary>
public sealed class CaseSensitiveCharComparer: CharComparer, IEqualityComparer<char>
{
    /// <summary>
    /// Compare two characters <b>(case sensitive)</b>
    /// </summary>
    ...
    /// <summary>
    /// Compare two characters <b>(case sensitive)</b> and return an indication of their relative sort order
    /// </summary>
    /// <param name="x">The character</param>
    /// <param name="y">The character to compare to</param>
